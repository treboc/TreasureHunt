    ...
    var body: some View {
      HStack(alignment: .firstTextBaseline) {
        ...
        VStack(alignment: .leading) {
          ...
          THToggle(isSelected: $viewModel.hasIntroduction)

          if viewModel.hasIntroduction {
            TextField(placeholder, text: $viewModel.introduction, axis: .vertical)
              .lineLimit(3...10)
              .padding()
      ...
      .animation(.easeInOut(duration: 0.3), value: viewModel.hasIntroduction)
      .padding()
    }
  }
}
